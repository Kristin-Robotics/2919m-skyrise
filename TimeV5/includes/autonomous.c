...
void gyroTurn(int degrees,int driveLBSpeed,int driveLFSpeed,int driveRBSpeed,int driveRFSpeed)
{
	...
	{
		if (((abs(SensortValue[turningGyro]) > degrees - 50) && (abs(SensortValue[turningGyro]) > degrees + 50)) || ((abs(SensortValue[turningGyro]) < degrees - 50) && (abs(SensortValue[turningGyro]) < degrees + 50))) //not within 100 of set angle
		{
