...
#pragma config(Motor,  port3,           lDrive2,       tmotorVex393HighSpeed, PIDControl, encoder, encoderPort, I2C_1, 1000)
...
#pragma config(Motor,  port8,           rDrive2,       tmotorVex393HighSpeed, PIDControl, reversed, encoder, encoderPort, I2C_2, 1000)
